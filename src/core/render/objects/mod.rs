...
//!
//! // Add a rectangle
//! let rect = Rectangle::new(10.0, 10.0, 200.0, 100.0, Color::BLUE);
//! scene.add_object(rect);
//!
//! // Add a line
//! let line = Line::new(10.0, 120.0, 210.0, 120.0, 2.0, Color::RED);
//! scene.add_object(line);
//!
//! // Add text
//! let text = TextObject::new("Hello, Objects!".to_string(), 15.0, 15.0, Color::BLACK);
