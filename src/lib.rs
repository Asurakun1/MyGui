...
//! - [`core::event`]: Defines the event handling system, including the [`Event`] enum, the
//!   [`EventHandler`] trait, and a suite of built-in handlers for common tasks.
//! - [`core::render`]: Contains the retained-mode rendering abstractions: the [`Scene`],
//!   the [`Drawable`] trait, and a collection of built-in drawable objects.
